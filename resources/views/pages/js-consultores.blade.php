...
<div class="section-when-header-with-bg">
    ...
    <p class="description">Brindamos servicios de elaboración y evaluación de proyectos de inversión pública a nivel de perfil, factibilidad y Expediente Técnico, Obras por impuestos, nstrumentos Metodológicos y capacitaciones, todos enfocados en el marco del Invierte.pe, principalmente, de los sectores Minería, Medio ambiente, Turismo, Producción y Comercio Exterior; asimismo, todos nuestros proyectos son considerados en el contexto de adaptación y mitigación al cambio climático.</p>
