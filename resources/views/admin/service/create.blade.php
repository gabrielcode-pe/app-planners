@extends('layouts.app')
@section('titulo') Registrar nuevo servicio @endsection
...
<div class="row mb-2">
    ...
    <form action="{{ url('/panel/service')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <input type="hidden" name="type" value="S">
    <div class="row">
    <section class="col-12 col-md-10">
        <div class="form-group">
            <input type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" aria-describedby="title" placeholder="Ingrese el título del servicio" value="{{old('title')}}" required>
            @if ($errors->has('title'))
    ...
    <section class="col-12 col-md-8">
        <div class="form-group">
            <textarea name="info" id="info" class="form-control ckeditor" rows="5" placeholder="Ingrese la información del servicio">{{old('info')}}</textarea>
